			...
			<div class="col-md-12">
				...
				<div class="card">
                                    <div class="card-header">
                                        ...
                                        <small id="userid"> ${admin.userID }</small>
							...
							value="${admin.avatar}" />
                                    <div style="padding-left: 20px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone" id="phone" placeholder="${admin.phone }" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="email" class=" form-control-label">Email:</label>
                                             <input type="text" name="email" id="email" placeholder="${admin.email }" class="form-control">
                                        
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <button class="btn btn-success" type="submit">Lưu thông tin chính sửa</button>
                                      <a href="<c:url value="/admin/profile"/>"  ><button type="button" class="btn btn-danger">Hủy</button></a>
                                         </div>
                                         </form>
                                    </div>

			...
			<div class="page-container">
				...
				<div class="card">
                                    <div class="card-header">
                                        ...
                                        <small id="userid"> ${shipper.userID }</small>
                                        
                                    </div>
                                    <div class="card-body card-block">
                                    <form action="./shipper-profile-edit" method="post" enctype="multipart/form-data">
							...
							value="${admin.avatar}" />
                                    <div style="padding-left: 20px">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" value="${shipper.name }" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="phone" class=" form-control-label">Số điện thoại:</label>
                                            <input type="text" name="phone" id="phone" value="${shipper.phone }" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="email" class=" form-control-label">Email:</label>
                                             <input type="text" name="email" id="email" value="${shipper.email }" class="form-control">
                                        
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <button class="btn btn-success" type="submit">Lưu thông tin chính sửa</button>
                                      <a href="<c:url value=""/>"  ><button type="button" class="btn btn-danger">Hủy</button></a>
                                         </div>
                                         </form>
                                    </div>

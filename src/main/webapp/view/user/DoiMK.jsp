...
<ul class="link">
  ...
  <section class="NoidungChinh">
            <div class="Noidung1">
                ...
                <ul class="noidung1_1">
                    <li><a class="noidungInfo" href="ChiTietND">Thông tin tài khoản</a></li>
                    <li><a class="noidungInfo" href="Donhang">Đơn hàng của bạn</a></li>
                    <li><a class="noidungInfo_active" href="">Đổi mật khẩu</a></li>
            ...
            <c:if test="${not empty error}">
                ...
                <div class="KhungDoiMK">
                    <div class="MKCu">
                        <p>Mật khẩu cũ</p>
                        <input class="MKhauCu" name="user" type="password" placeholder="Nhập mật khẩu cũ">
                    </div>
                    <div class="MKMoi1">
                        <p>Mật khẩu mới</p>
                        <input class="MKhauMoi1" name="pass" type="password" placeholder="Nhập lại mật khẩu mới">
                    </div>
                    <div class="MKMoi2">
                        <p>Nhập lại mật khẩu mới</p>
                        <input class="MKhauMoi2" name="repass" type="password" placeholder="Nhập mật khẩu mới">
                    </div>
                    <button type="submit" onclick="" class="btn_changePW">
                        Đặt lại mật khẩu
                    </button>
                </div>

            ...
            <div class="khung1">
                <div class="khung1_1">
                    <div class="khung1_1_1">
                        ...
                        <div class="khungDienTT">
                                ...
                                <input name="ten" type="text"placeholder="Họ và tên" value="${user.name}"><br>
                                <input name="email" type="email" placeholder="Email" value="${user.email}"><br>
                                <input name="phone" type="text" placeholder="Số điện thoại" value="${user.phone}"><br>
                                <input name="diachi" type="text" placeholder="Địa chỉ số"><br>
                                <select>
                                ...
                                <select>
                                    <option>Vui lòng chọn Quận/Huyện/Thành phố/Thị xã</option>
                                    <option>Tân An</option>
                                    <option>Kiến Tường</option>
                                    <option>Mộc Hóa</option>
                                    <option>Tân Thạnh</option>

                                </select><br>
                                <select>
                                    <option>Vui lòng chọn Xã/Phường/Thị trấn</option>
                                    <option>Thạnh Trị</option>
                                    <option>Phường 1</option>
                                    <option>Bình Hiệp</option>
                ...
                <div class="khung1_2">
                    ...
                    <div class="sanphamtrongDonHang">
                        <div class="sp_1">
                            <img src="${sp.img}"  style="width: 70px;" class="anh_sp">	
                            <p class="ten_sp" style="line-height: 50px;">${sp.namePro}</p>
                            <p class="gia_sp" style="line-height: 50px;">${sp.price}<sup>đ</sup></p>
                    ...
                    <div class="tinhTien">
                        <div class="tongTienSp">
                            ...
                            <p class="phi">${tong}<sup>vnd</sup></p>
                        </div>

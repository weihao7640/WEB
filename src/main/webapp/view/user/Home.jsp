...
<body>
	...
	<div class="banner">
		<img src="image/banner_1.webp" alt="">
		 <img src="image/banner_2.webp" alt=""> 
		 <img src="image/banner_3.webp" alt="">
	</div>
		<div class="tieude">
	...
	<div id="content" class="menu">
		...
		<c:forEach items="${listP}" var="o">
			<div class="menu-item">
				<a href="chitiet?id=${o.proid}"><img src="${o.img}" width="190px" alt=""></a>
				 <span class="item_text"> <a href="chitiet?id=${o.proid}"> ${o.namePro}</a>
				</span> <span class="item_gia"> ${o.price}/KG </span> <span class="item_daban">
					Đã bán ${o.sold} </span>
			<a href="chitiet?id=${o.proid}">
				<div class="layer2">
					<div class="icon">
	...
	<div class="banner">
		<img src="image/banner_4.jpg" width="370px" alt="">
		 <img src="image/banner_5.jpg" width="370px"  alt=""> 
		 <img src="image/banner_6.jpg" width="370px"  alt="">
	</div>
	 <div class="tieude">
	<img src="image/title.webp" alt="">
	<h2>Sản phẩm bán chạy</h2>
	...
	<div class="giamgia">
		<div style="width: 420px; height: 615px; border:1px solid red;" class="menu-item">
			<img src="image/sp11_1.webp" width="410px" alt=""> <span class="item_text"> <a href=""> ${o.namePro}</a>
